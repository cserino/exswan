defmodule ExWebauthn.CBORUtils do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ExWebauthn.CBORUtils.decode_attestation_object(cbor_data)
      {:ok, %{
        "fmt" => "packed",
        "authData" => <<...>>,
        "attStmt" => %{...}
  ...
  ## Examples
      ...
      iex> ExWebauthn.CBORUtils.decode_credential_public_key(cbor_data)
      {:ok, %{
  ...
  ## Examples
      ...
      iex> ExWebauthn.CBORUtils.validate_attestation_object(%{"fmt" => "packed", "authData" => <<...>>})
      :ok

      iex> ExWebauthn.CBORUtils.validate_attestation_object(%{"invalid" => "data"})
