defmodule ExSwan.AttestationCryptoTest do
  use ExUnit.Case
  alias ExSwan.AttestationStatement
  ...
  describe "FIDO U2F signature verification" do
    ...
    test "verifies valid FIDO U2F signature", %{
      ...
      {:ok, %{-2 => x, -3 => y}} =
        ExSwan.CBORUtils.decode_credential_public_key(public_key_cbor)
  ...
  defp create_test_auth_data_with_key(cose_public_key) do
    ...
    {:ok, encoded_key} = ExSwan.CBORUtils.encode_credential_public_key(cose_public_key)
