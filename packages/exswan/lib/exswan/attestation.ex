defmodule ExSwan.Attestation do
  @moduledoc """
...
defimpl Jason.Encoder, for: ExSwan.Attestation.CreationOptions do
  alias ExSwan.Attestation.CreationOptions
...
defimpl Jason.Encoder, for: ExSwan.Attestation.AuthenticatorSelection do
  alias ExSwan.Attestation.AuthenticatorSelection
