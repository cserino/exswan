defmodule ExSwan.Assertion do
  ...
  alias ExSwan.Attestation.AuthenticatorData
...
defimpl Jason.Encoder, for: ExSwan.Assertion.RequestOptions do
  alias ExSwan.Assertion.RequestOptions
